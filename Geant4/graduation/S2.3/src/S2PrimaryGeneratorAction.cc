...
//  fParticleGun->SetParticlePosition(G4ThreeVector(1.*cm,0.,0.));
  fParticleGun->SetParticleMomentumDirection(G4ThreeVector(-1.*cm,0.,0.));
//  fParticleGun->SetParticleEnergy(GenerateE());
fParticleGun->SetParticlePosition(G4ThreeVector(1.*cm,(G4UniformRand()-0.5)*4.*mm,(G4UniformRand()-0.5)*4.*mm));
