...
//
//create histograms
analysisManager->CreateH1("Gamma","Kineticenergy of Gamma",1000,0.,200*MeV);
analysisManager->CreateH1("Electron"," Kineticenergy of Electron",500,0.,200*MeV);
analysisManager->CreateH1("Positron","Kineticenergy of Positron",500,0.,200*MeV);
//create ntuple
