...
class RunAction : public G4UserRunAction
{
  ...
  public:
    ...
    ~ParticleStatistics();
    void EventFinished();
    void FillData(G4double kinEnergy, 
...
public:
  ...
  void FillData(const G4ParticleDefinition* particle,
                G4double kinEnergy, G4double xPolarization, G4double yPolarization, G4double longitudinalPolarization);
  void Fill(G4double gammaKinEnergy,G4double x,G4double y);
  void EventFinished();
...
private:
  ...
  std::ofstream initialGammaEnergy;
  std::ofstream initialGammaPosition;
