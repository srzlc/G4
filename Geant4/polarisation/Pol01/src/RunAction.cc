...
//  fAnalysisManager->SetActivation(true);
  ...
  const G4String title[] = 
                { "Gamma Energy distribution",                      //1
                  ...
                  "Gamma xPolarization",                            //4
                  "Gamma yPolarization",                            //5
                  "Gamma longitudinal Polarization",                //6
                  "Electron Energy distribution",                   //7
                  "Electron Cos(Theta) distribution",               //8
                  "Electron Phi angular distribution",              //9
                  "Electron xPolarization",                         //10
                  "Electron yPolarization",                         //11
                  "Electron longitudinal Polarization",             //12
                  "Positron Energy distribution",                   //13
                  "Positron Cos(Theta) distribution",               //14
                  "Positron Phi angular distribution",              //15
                  "Positron xPolarization",                         //16
                  "Positron yPolarization",                         //17
                  "Positron longitudinal Polarization"              //18
                };
  G4double vmin, vmax;
  G4int nbins = 120;
  for(int i=0; i<18; ++i) {
    ...
    else if(2==j) { vmin = -180.*deg; vmax = 180.*deg; }
    else if(3==j) { vmin = -1.5; vmax = 1.5; }
    else if(4==j) { vmin = -1.5; vmax = 1.5; }
    else          { vmin = -1.5; vmax = 1.5; }
     fAnalysisManager->CreateH1(id[i],title[i],nbins,vmin,vmax);
